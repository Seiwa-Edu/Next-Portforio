      ...
      <div>
        ...
        <section className={style_css.skill_section}>
          <div className={style_css.skill__wrapper}>
            ...
            <div className={style_css.programming__comp}>
            <div className={style_css.programming_image}><a href="https://www.credly.com"><img src="/aws-certified-cloud-practitioner.png" className={style_css.programming__Logo} alt="AWS Logo"/></a></div>
              <div className={style_css.programming_text}>
